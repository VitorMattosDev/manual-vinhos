...
- [x] `v7-estagio-envelhecimento/02-envelhecimento-em-garrafa.qmd` — evolução, potencial de guarda. *fig.: curva de evolução × tempo.*
- [x] `v7-estagio-envelhecimento/03-engarrafamento-e-vedantes.qmd` — rolha, screwcap, vidro. *fig.: tipos de vedante.*
- [x] `v7-estagio-envelhecimento/04-defeitos-do-vinho.qmd` — TCA, oxidação, redução, brett. *fig.: mapa de defeitos × causa.*
...
- [x] `v13-cultura-mercado/03-sustentabilidade-e-clima.qmd` — orgânico, biodinâmico, mudança climática. *fig.: deslocamento de zonas climáticas.*
- [x] `v13-cultura-mercado/04-certificacoes-e-carreiras.qmd` — WSET, sommelier, Master of Wine. *fig.: trilhas de certificação.*
- [x] `v13-cultura-mercado/05-tendencias-e-futuro.qmd` — naturais, sem álcool, novas regiões. *fig.: linha do tempo de tendências.*
